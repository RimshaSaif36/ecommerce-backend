...
adminRouter.post(
  "/register",
  upload.single("adminProfileImage"), // ✅ keep this consistent
...
adminRouter.put(
  ...
  isLoggedIn,
  upload.single("adminProfileImage"), // ✅ same field name
  updateAdminProfileImage
);

adminRouter.delete("/:adminId/profile-image", isLoggedIn, deleteAdminProfileImage);
